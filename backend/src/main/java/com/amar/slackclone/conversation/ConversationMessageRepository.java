...
public interface ConversationMessageRepository extends JpaRepository<ConversationMessage, Long> {
    ...
    List<ConversationMessage> findAllByConversationIdAndSenderIdOrderById(Long conversationId,Long senderId);
    List<ConversationMessage> findAllByConversationIdAndIdLessThanEqualAndSenderIdNotOrderById(Long conversationId,Long throughId,Long senderId);
    ...
    List<ConversationMessage> findByConversationIdAndIdLessThanEqualAndCreatedAtGreaterThanEqualOrderByIdDesc(Long conversationId,Long targetId,java.time.OffsetDateTime joinedAt,Pageable page);
    List<ConversationMessage> findByConversationIdAndIdGreaterThanAndCreatedAtGreaterThanEqualOrderById(Long conversationId,Long targetId,java.time.OffsetDateTime joinedAt,Pageable page);
